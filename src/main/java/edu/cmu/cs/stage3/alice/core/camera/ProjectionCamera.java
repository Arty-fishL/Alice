...
public class ProjectionCamera extends edu.cmu.cs.stage3.alice.core.Camera {
	public final Matrix44Property projection = new Matrix44Property(this, "projection",
	...
	protected edu.cmu.cs.stage3.alice.core.decorator.ViewVolumeDecorator createViewVolumeDecorator() {
		final edu.cmu.cs.stage3.alice.core.decorator.ProjectionViewVolumeDecorator projectionViewVolumeDecorator = new edu.cmu.cs.stage3.alice.core.decorator.ProjectionViewVolumeDecorator();
