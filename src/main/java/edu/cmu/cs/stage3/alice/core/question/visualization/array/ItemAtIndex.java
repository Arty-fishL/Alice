...
public class ItemAtIndex extends edu.cmu.cs.stage3.alice.core.question.ModelQuestion {
	public final ArrayOfModelsVisualizationProperty subject = new ArrayOfModelsVisualizationProperty(this, "subject",
			null);
	public final NumberProperty index = new NumberProperty(this, "index", new Integer(-1));

	@Override
	public Object getValue() {
		final edu.cmu.cs.stage3.alice.core.visualization.ArrayOfModelsVisualization arrayOfModelsVisualizationValue = subject
				.getArrayOfModelsVisualizationValue();
