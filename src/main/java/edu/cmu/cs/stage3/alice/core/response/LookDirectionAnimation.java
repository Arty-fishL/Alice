...
public class LookDirectionAnimation extends OrientationAnimation {
	public final edu.cmu.cs.stage3.alice.core.property.DirectionProperty lookDirection = new edu.cmu.cs.stage3.alice.core.property.DirectionProperty(
			this, "lookDirection", Direction.FORWARD);
	...
	public class RuntimeLookDirectionAnimation extends RuntimeOrientationAnimation {
		...
		public void prologue(final double t) {
			...
			initialQuat = head
					.getOrientationAsQuaternion((edu.cmu.cs.stage3.alice.core.ReferenceFrame) head.getParent());
			targetQuat = null;
		...
		public void update(final double t) {
			...
			final edu.cmu.cs.stage3.math.Quaternion q = edu.cmu.cs.stage3.math.Quaternion.interpolate(initialQuat,
					targetQuat, getPortion(t));
		...
		public edu.cmu.cs.stage3.math.Quaternion getTargetQuaternion() {
			...
			final edu.cmu.cs.stage3.math.Quaternion quat = head
					.getOrientationAsQuaternion((edu.cmu.cs.stage3.alice.core.ReferenceFrame) head.getParent());
			final edu.cmu.cs.stage3.math.Matrix33 orient = new edu.cmu.cs.stage3.math.Matrix33();

			final double amt = amount.doubleValue();
		...
		public void findHead() {
			final edu.cmu.cs.stage3.alice.core.Element[] heads = m_subject
					.search(new ElementNameContainsCriterion("head"));
