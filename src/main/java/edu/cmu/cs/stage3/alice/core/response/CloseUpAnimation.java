...
public class CloseUpAnimation extends AbstractPositionAnimation {
	...
	public static CloseUpAnimation createCloseUpAnimation(final Object subject, final Object spatialRelation,
			final Object amount, final Object asSeenBy) {
		final CloseUpAnimation closeUpAnimation = new CloseUpAnimation();
	...
	public class RuntimeCloseUpAnimation extends RuntimeAbstractPositionAnimation {
		...
		protected javax.vecmath.Vector3d getPositionEnd() {
			...
			if (sv.equals(edu.cmu.cs.stage3.alice.core.SpatialRelation.LEFT_OF)) {
				...
				cameraEndOrientation.setForwardUpGuide(new javax.vecmath.Vector3d(-0.7071068, 0, 0.7071068),
						cameraEndOrientation.getRow(1));
			...
			final javax.vecmath.Vector3d v = sv.getPlaceVector(m_amount, m_subjectBoundingBox, m_asSeenByBoundingBox);
			// 1.25 is fudge factor to leave space for speech bubbles
			final double halfViewable = m_asSeenBy.getHeight() * 1.5 * amount.doubleValue() / 2.0;
		...
		public void prologue(final double t) {
			...
			if (m_asSeenBy == null) {
				throw new edu.cmu.cs.stage3.alice.core.SimulationPropertyException("character value must not be null.",
						getCurrentStack(), CloseUpAnimation.this.asSeenBy);
			}
			...
			if (m_subject == null) {
				throw new edu.cmu.cs.stage3.alice.core.SimulationPropertyException("subject value must not be null.",
						getCurrentStack(), CloseUpAnimation.this.subject);
			}
