...
public class CharacterViewAnimation extends AbstractPositionAnimation {
	...
	public static CharacterViewAnimation createCharacterViewAnimation(final Object subject, final Object asSeenBy) {
		final CharacterViewAnimation charViewAnimation = new CharacterViewAnimation();
	...
	public class RuntimeCloseUpAnimation extends RuntimeAbstractPositionAnimation {
		...
		protected javax.vecmath.Vector3d getPositionEnd() {
			...
			if (asSeenBy.get() instanceof Model) {
				final Model character = (Model) asSeenBy.get();
				final edu.cmu.cs.stage3.alice.core.Element[] heads = character
		...
		public void prologue(final double t) {
			...
			if (m_asSeenBy == null) {
				throw new edu.cmu.cs.stage3.alice.core.SimulationPropertyException("character value must not be null.",
						getCurrentStack(), CharacterViewAnimation.this.asSeenBy);
			}
			super.prologue(t);
			if (m_subject == m_asSeenBy) {
				throw new edu.cmu.cs.stage3.alice.core.SimulationPropertyException(
						...
						CharacterViewAnimation.this.subject);
			}
		...
		public void update(final double t) {
			...
			m_subject.setOrientationRightNow(
					edu.cmu.cs.stage3.math.Matrix33.interpolate(m_orientationBegin, m_orientationEnd, getPortion(t)),
