...
class VisualProxy extends edu.cmu.cs.stage3.alice.scenegraph.renderer.nativerenderer.VisualProxy {
	...
	@Override
	protected native void onFrontFacingAppearanceChange(
			edu.cmu.cs.stage3.alice.scenegraph.renderer.nativerenderer.AppearanceProxy value);

	@Override
	protected native void onBackFacingAppearanceChange(
			edu.cmu.cs.stage3.alice.scenegraph.renderer.nativerenderer.AppearanceProxy value);

	@Override
	protected native void onGeometryChange(
			edu.cmu.cs.stage3.alice.scenegraph.renderer.nativerenderer.GeometryProxy value);
	...
	@Override
	protected native void onDisabledAffectorsChange(
			edu.cmu.cs.stage3.alice.scenegraph.renderer.nativerenderer.AffectorProxy[] affectors);
}
