...
class IconManager {
	...
	static {
		...
		s_classToImageMap.put(edu.cmu.cs.stage3.alice.core.light.DirectionalLight.class,
				loadImageFromResource("images/directionalLight.gif"));
		s_classToImageMap.put(edu.cmu.cs.stage3.alice.core.light.PointLight.class,
				loadImageFromResource("images/pointLight.png"));
		// s_classToImageMap.put(
		// edu.cmu.cs.stage3.alice.core.light.SpotLight.class,
		// loadImageFromResource( "images/spotLight.png" ) );
		s_classToImageMap.put(edu.cmu.cs.stage3.alice.core.camera.SymmetricPerspectiveCamera.class,
				loadImageFromResource("images/camera.png"));
		s_classToImageMap.put(edu.cmu.cs.stage3.alice.core.TextureMap.class,
				loadImageFromResource("images/types/edu.cmu.cs.stage3.alice.core.TextureMap.gif"));
		s_classToImageMap.put(edu.cmu.cs.stage3.alice.core.Sound.class,
				loadImageFromResource("images/types/edu.cmu.cs.stage3.alice.core.Sound.gif"));
		s_classToImageMap.put(edu.cmu.cs.stage3.alice.core.Pose.class,
				loadImageFromResource("images/types/edu.cmu.cs.stage3.alice.core.Pose.gif"));
	}

	static private javax.swing.ImageIcon loadImageFromResource(final String name) {
		final java.net.URL resource = edu.cmu.cs.stage3.alice.authoringtool.JAlice.class.getResource(name);
