...
public abstract class RenderTargetAdapter {
	...
	public abstract void pick(CameraProxy cameraProxy, int x, int y, boolean isSubElementRequired,
			boolean isOnlyFrontMostRequired, int[] atVisual, boolean[] atIsFrontFacing, int[] atSubElement,
			double[] atZ);
	...
	public abstract double getActualHorizontalViewingAngle(
			SymmetricPerspectiveCameraProxy symmetricPerspectiveCameraProxy);

	public abstract double getActualVerticalViewingAngle(
			SymmetricPerspectiveCameraProxy symmetricPerspectiveCameraProxy);
	...
	public abstract void setIsLetterboxedAsOpposedToDistorted(CameraProxy cameraProxy,
	...
	public abstract void setRendersOnEdgeTrianglesAsLines(OrthographicCameraProxy orthographicCameraProxy,
	...
	public abstract void getPixels(int x, int y, int width, int height, int pitch, int bitCount, int redBitMask,
	...
	public abstract void getZBufferPixels(int x, int y, int width, int height, int zPitch, int zBitCount,
			int[] zPixels);
	...
	public abstract void getPixels(TextureMapProxy textureMapProxy, int x, int y, int width, int height, int pitch,
			int bitCount, int redBitMask, int greenBitMask, int blueBitMask, int alphaBitMask, int[] pixels);
