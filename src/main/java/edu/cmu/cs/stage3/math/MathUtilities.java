...
public class MathUtilities {
	...
	public static javax.vecmath.Vector3d createVector3d(final javax.vecmath.Tuple4d t) {
		return new javax.vecmath.Vector3d(t.x / t.w, t.y / t.w, t.z / t.w);
	}

	public static javax.vecmath.Vector4d createVector4d(final javax.vecmath.Tuple3d t, final double tW) {
		return new javax.vecmath.Vector4d(t.x, t.y, t.z, tW);
	}

	public static javax.vecmath.Point3d createPoint3d(final javax.vecmath.Tuple4d t) {
		return new javax.vecmath.Point3d(t.x / t.w, t.y / t.w, t.z / t.w);
	}

	public static javax.vecmath.Point4d createPoint4d(final javax.vecmath.Tuple3d t, final double tW) {
		return new javax.vecmath.Point4d(t.x, t.y, t.z, tW);
	}

	public static double getItem(final javax.vecmath.Vector3d vector, final int i) {
		switch (i) {
		case 0:
			return vector.x;
		case 1:
	...
	public static void setItem(final javax.vecmath.Vector3d vector, final int i, final double value) {
		switch (i) {
		case 0:
			vector.x = value;
			return;
	...
	public static javax.vecmath.Vector3d add(final javax.vecmath.Vector3d a, final javax.vecmath.Vector3d b) {
		return new javax.vecmath.Vector3d(a.x + b.x, a.y + b.y, a.z + b.z);
	}

	public static javax.vecmath.Vector3d subtract(final javax.vecmath.Vector3d a, final javax.vecmath.Vector3d b) {
		return new javax.vecmath.Vector3d(a.x - b.x, a.y - b.y, a.z - b.z);
	}

	public static javax.vecmath.Vector3d negate(final javax.vecmath.Vector3d v) {
		return new javax.vecmath.Vector3d(-v.x, -v.y, -v.z);
	}

	public static javax.vecmath.Vector3d multiply(final javax.vecmath.Vector3d v, final double scalar) {
		return new javax.vecmath.Vector3d(v.x * scalar, v.y * scalar, v.z * scalar);
	}

	public static javax.vecmath.Vector3d multiply(final javax.vecmath.Vector3d v, final javax.vecmath.Vector3d scalar) {
		return new javax.vecmath.Vector3d(v.x * scalar.x, v.y * scalar.y, v.z * scalar.z);
	}

	public static javax.vecmath.Vector3d divide(final javax.vecmath.Vector3d v, final double divisor) {
		return multiply(v, 1 / divisor);
	}

	public static javax.vecmath.Vector3d divide(final javax.vecmath.Vector3d numerator,
			final javax.vecmath.Vector3d divisor) {
		return new javax.vecmath.Vector3d(numerator.x / divisor.x, numerator.y / divisor.y, numerator.z / divisor.z);
	}

	public static javax.vecmath.Vector3d invert(final javax.vecmath.Vector3d v) {
		return new javax.vecmath.Vector3d(1 / v.x, 1 / v.y, 1 / v.z);
	}

	public static javax.vecmath.Vector3d normalizeV(final javax.vecmath.Vector3d v) {
		final javax.vecmath.Vector3d nv = new javax.vecmath.Vector3d(v);
		nv.normalize();
		return nv;
	}
	...
	public static double getLength(final double x, final double y, final double z) {
		final double lengthSquared = getLengthSquared(x, y, z);
		if (lengthSquared == 1) {
			return 1;
		} else {
	...
	public static double getLengthSquared(final javax.vecmath.Vector3d v) {
		return getLengthSquared(v.x, v.y, v.z);
	}

	public static double getLength(final javax.vecmath.Vector3d v) {
	...
	public static javax.vecmath.Vector3d crossProduct(final javax.vecmath.Vector3d a, final javax.vecmath.Vector3d b) {
		return new javax.vecmath.Vector3d(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x);
	}

	public static javax.vecmath.Vector3d interpolate(final javax.vecmath.Vector3d a, final javax.vecmath.Vector3d b,
			final double portion) {
		return new javax.vecmath.Vector3d(a.x + (b.x - a.x) * portion, a.y + (b.y - a.y) * portion,
				a.z + (b.z - a.z) * portion);
	}

	public static javax.vecmath.Vector3d projectOnto(final javax.vecmath.Vector3d a, final javax.vecmath.Vector3d b) {
		return multiply(b, dotProduct(b, a) / dotProduct(b, b));
	}

	public static javax.vecmath.Vector3d multiply(final javax.vecmath.Matrix3d a, final javax.vecmath.Vector3d b) {
	...
	public static javax.vecmath.Vector3d multiply(final javax.vecmath.Vector3d a, final javax.vecmath.Matrix4d b) {
		final javax.vecmath.Vector3d ab = new javax.vecmath.Vector3d();
	...
	public static javax.vecmath.Vector3d combine(final javax.vecmath.Vector3d a, final javax.vecmath.Vector3d b,
			final double asc1, final double bsc1) {
		final javax.vecmath.Vector3d ab = new javax.vecmath.Vector3d();
	...
	public static double getItem(final javax.vecmath.Vector4d vector, final int i) {
		switch (i) {
		case 0:
			return vector.x;
		case 1:
	...
	public static void setItem(final javax.vecmath.Vector4d vector, final int i, final double value) {
		switch (i) {
		case 0:
			vector.x = value;
			return;
	...
	public static javax.vecmath.Vector4d negate(final javax.vecmath.Vector4d v) {
		return new javax.vecmath.Vector4d(-v.x, -v.y, -v.z, -v.w);
	}

	public static double dotProduct(final javax.vecmath.Vector4d a, final javax.vecmath.Vector4d b) {
		return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w;
	}

	public static javax.vecmath.Vector4d multiply(final double aX, final double aY, final double aZ, final double aW,
			final javax.vecmath.Matrix4d b) {
		final javax.vecmath.Vector4d ab = new javax.vecmath.Vector4d();
	...
	public static javax.vecmath.Vector4d multiply(final javax.vecmath.Vector4d a, final javax.vecmath.Matrix4d b) {
		return multiply(a.x, a.y, a.z, a.w, b);
	}

	public static javax.vecmath.Vector4d multiply(final javax.vecmath.Vector3d a, final double aW,
			final javax.vecmath.Matrix4d b) {
		return multiply(a.x, a.y, a.z, aW, b);
	}

	public static javax.vecmath.Vector4d multiply(final javax.vecmath.Matrix4d a, final double bX, final double bY,
			final double bZ, final double bW) {
		final javax.vecmath.Vector4d ab = new javax.vecmath.Vector4d();
	...
	public static javax.vecmath.Vector4d multiply(final javax.vecmath.Matrix4d a, final javax.vecmath.Vector4d b) {
		return multiply(a, b.x, b.y, b.z, b.w);
	}

	public static javax.vecmath.Vector4d multiply(final javax.vecmath.Matrix4d a, final javax.vecmath.Vector3d b,
			final double bW) {
		return multiply(a, b.x, b.y, b.z, bW);
	}

	public static javax.vecmath.Vector3d getRow(final javax.vecmath.Matrix3d m, final int i) {
		switch (i) {
		case 0:
	...
	public static void setRow(final javax.vecmath.Matrix3d m, final int i, final javax.vecmath.Vector3d v) {
		switch (i) {
		case 0:
			m.m00 = v.x;
			m.m01 = v.y;
	...
	public static javax.vecmath.Vector3d getColumn(final javax.vecmath.Matrix3d m, final int i) {
		switch (i) {
		case 0:
	...
	public static void setColumn(final javax.vecmath.Matrix3d m, final int i, final javax.vecmath.Vector3d v) {
		switch (i) {
		case 0:
			m.m00 = v.x;
			m.m10 = v.y;
	...
	public static javax.vecmath.Matrix3d multiply(final javax.vecmath.Matrix3d a, final javax.vecmath.Matrix3d b) {
		final javax.vecmath.Matrix3d m = new javax.vecmath.Matrix3d();
	...
	public static javax.vecmath.Matrix4d multiply(final javax.vecmath.Matrix4d a, final javax.vecmath.Matrix4d b) {
		final javax.vecmath.Matrix4d m = new javax.vecmath.Matrix4d();
	...
	public static boolean contains(final javax.vecmath.Tuple3d t, final double d) {
		if (Double.isNaN(d)) {
