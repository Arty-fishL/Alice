...
public class TConversionTool {
	...
	public static int unsignedByteToInt16(final byte[] buffer, final int offset, final boolean isBigEndian) {
		/*
	...
	public static int unsignedByteToInt24(final byte[] buffer, final int offset, final boolean isBigEndian) {
		if (isBigEndian) {
	...
	public static int unsignedByteToInt32(final byte[] buffer, final int offset, final boolean isBigEndian) {
		if (isBigEndian) {
	...
	public static byte intToUnsignedByte(final int sample) {
		/*
	...
	public static void intToUnsignedBytes16(final int sample, final byte[] buffer, final int byteOffset,
	...
	public static void intToUnsignedBytes24(final int sample, final byte[] buffer, final int byteOffset,
			final boolean bigEndian) {
		if (bigEndian) {
	...
	public static void intToUnsignedBytes32(final int sample, final byte[] buffer, final int byteOffset,
			final boolean bigEndian) {
		if (bigEndian) {
